...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mRAKIB islam
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801942371412
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mRAKIB Technology channel
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/c/RAKIBTechnologychannel")
		exit()
	else:
		os.system("https://youtube.com/c/RAKIBTechnologychannel")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [RAKIB] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [RAKIB-CP] %s|%s        '%(b,idf,pw))
...
if __name__=='__main__':
	...
	os.system("xdg-open https://youtube.com/c/Sk Rakib")
	menu()
